...
boss_menu = Janela("Menu de supervisor", 350, 350)
...
def open_menu1():
    ...
    def new_empl(lista):
        ...
        # Possivelmente adicionar mais filtros nas entradas !
    ...
    boss_menu.createButton("Demitir funcionário", fire_empl, tabela_funcionarios, X-padding-0.015, Y+i*line_height, relative=True, anch="ne", color='Crimson')
    i+=2
...
login.createButton("Supervisor", open_menu1, placex=0.5, placey=0.35, relative=True, anch="center")
